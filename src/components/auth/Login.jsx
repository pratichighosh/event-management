    ...
    >
      ...
      <div className="bg-white bg-opacity-95 p-10 rounded-3xl shadow-2xl w-full max-w-md relative z-10 overflow-hidden">
        ...
        <div className="text-center mb-10">
          <h2 className="text-4xl font-bold-italic text-teal-700 mb-2">Welcome Back</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="relative">
            <label 
              htmlFor="email" 
              className="block text-sm font-medium-italic text-teal-800 mb-2"
            >
              Email Address
            </label>
            <div className="relative">
          ...
          <div className="relative">
            ...
            <div className="text-right mt-2">
              <Link 
                to="/forgot-password" 
                className="text-sm text-teal-600 hover:text-purple-800 font-medium"
              >
                Forgot Password?
              </Link>
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-teal-400 text-white py-3 rounded-xl hover:bg-purple-700 transition-colors flex items-center justify-center group mt-6"
          >
        ...
        <p className="mt-8 text-center text-black-600">
          ...
          <Link to="/register" className="text-teal-600 hover:text-purple-700 font-semibold">
            Register
          </Link>
        </p>
      </div>
